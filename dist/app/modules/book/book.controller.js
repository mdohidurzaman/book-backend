...
const createBook = (0, catchasyne_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllBooks = (0, catchasyne_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleBook = (0, catchasyne_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateBook = (0, catchasyne_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
...
const deleteBook = (0, catchasyne_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
